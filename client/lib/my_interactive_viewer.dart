...
/// See also:
///
///   * [MyInteractiveViewer.builder], whose builder is of this type.
...
class MyInteractiveViewer extends StatefulWidget {
  ...
  MyInteractiveViewer({
    ...
    this.constrained = (horizontal: true, vertical: true),
  ...
  MyInteractiveViewer.builder({
    ...
    required InteractiveViewerWidgetBuilder this.builder,
        ...
        constrained = (horizontal: false, vertical: false),
        child = null;
  ...
  ///
  /// Passed with the [MyInteractiveViewer.builder] constructor. Otherwise, the
  ...
  ///
  /// If the [MyInteractiveViewer.builder] constructor is used, then this will be
  ...
  /// {@end-tool}
  final ({bool horizontal, bool vertical}) constrained;
  ...
  static Vector3 getNearestPointInside(Vector3 point, Quad quad) {
    ...
    final List<Vector3> closestPoints = <Vector3>[
      MyInteractiveViewer.getNearestPointOnLine(
...
class _MyInteractiveViewerState extends State<MyInteractiveViewer>
  ...
  @override
  void didUpdateWidget(MyInteractiveViewer oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.child != null) {
      ...
      assert(!widget.constrained.horizontal && !widget.constrained.vertical);
      child = LayoutBuilder(
...
class _InteractiveViewerBuilt extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (!constrained.horizontal | !constrained.vertical) {
      child = OverflowBox(
        alignment: Alignment.topLeft,
        fit: OverflowBoxFit.deferToChild,
        minWidth: constrained.horizontal ? null : 0.0,
        minHeight: constrained.vertical ? null : 0.0,
        maxWidth: constrained.horizontal ? null : double.infinity,
        maxHeight: constrained.vertical ? null : double.infinity,
        child: child,
      );
    }
...
Quad _getAxisAlignedBoundingBoxWithRotation(Rect rect, double rotation) {
  ...
  return MyInteractiveViewer.getAxisAlignedBoundingBox(boundariesRotated);
}
...
Offset _exceedsBy(Quad boundary, Quad viewport) {
  ...
  for (final Vector3 point in viewportPoints) {
    final Vector3 pointInside =
        MyInteractiveViewer.getNearestPointInside(point, boundary);
...
/// This enum is used to specify the behavior of the [MyInteractiveViewer] when
